...
if($argc != 6)
{
	...
	printf("Example: %s tv2011 1 2100 2 ./runme_BowEncoding.sh\n", $argv[0]);
	exit();
}

$szScript = "/net/per610a/export/das11f/ledduy/ndthanh/InstanceSearch2013/code/matlab/ins13BowEncoding.sgejob.sh";
$year = $argv[1];
$nMinVal = $argv[2];
$nMaxVal = $argv[3];
$nStep = $argv[4];
