...
echo [$HOSTNAME] [$JOB_ID] [ksc-BOW-ComputeAssignmentAndSoftBOW] [$1] [$2] [$3] [$4] [$5] 
...
# Command -  *** CHANGED ***
/net/per900b/raid0/ledduy/usr.local/bin/php -f ksc-BOW-ComputeAssignmentAndSoftBOW.php $1 $2 $3 $4 $5 
