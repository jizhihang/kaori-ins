...
#$ -q all.q@@bc1hosts,all.q@@bc5hosts,all.q@@bc3hosts,
...
echo [$HOSTNAME] [$JOB_ID] [ksc-BOW-GetKeyFrameSize] [$1] [$2] [$3] [$4] [$5]
...
# Command -   *** CHANGED ***
/net/per900b/raid0/ledduy/usr.local/bin/php -f ksc-BOW-GetKeyFrameSize.php $1 $2 $3 $4 $5
