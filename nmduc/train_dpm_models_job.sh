...
matlab -nodisplay -r "cd /net/per900c/raid0/ledduy/github-projects/kaori-ins2014/voc-release5; addpath('/net/per610a/export/das11f/ledduy/trecvid-ins-2014/model/ins-dpm/tv2013/query2013/$1'); global VOC_CONFIG_OVERRIDE; VOC_CONFIG_OVERRIDE = @voc_config_$1;  train_model('query_$1', 1);"
# Log ending time
date
