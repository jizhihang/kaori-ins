...
matlab -nodisplay -r "cd /net/per900c/raid0/ledduy/github-projects/kaori-ins2014/voc-release5; addpath('/net/per610a/export/das11f/ledduy/trecvid-ins-2014/model/ins-dpm/tv2014/query2014/$1'); global VOC_CONFIG_OVERRIDE; VOC_CONFIG_OVERRIDE = @voc_config_$1;  train_model('query_$1', 1);"
# Log ending time
date

#addpath('/net/per610a/export/das11f/ledduy/trecvid-ins-2014/model/ins-dpm/tv2014/query2014/9099'); global VOC_CONFIG_OVERRIDE; VOC_CONFIG_OVERRIDE = @voc_config_9069;
#train_model( 'query_9099', 1);
