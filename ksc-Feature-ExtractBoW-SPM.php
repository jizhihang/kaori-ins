...
computeSoftBOWHistogramWithGridForOnePat($szTmpDir, $szFeatureConfigParam, 
$szRootFeatureOutputDir, $szRootKeyFrameDir, $szRootMetaDataDir, 
$szSashCentroidDir, $szSashCentroidName, $szPrefixAnn, 
$szTargetPatName, $szInputRawFeatureExt, $szBOWFeatureExt, $nMaxCodeBookSize, $nStartID, $nEndID);
...
// ///////////////////////////// FUNCTIONS //////////////////////////////
function computeSoftBOWHistogramWithGridForOnePat(
    $szLocalDir, $szFeatureConfigParam, 
    $szRootFeatureOutputDir, $szRootKeyFrameDir, $szRootMetaDataDir, 
    $szSashCentroidDir, $szSashCentroidName, $szPrefixAnn, 
    $szPatName, $szInputRawFeatureExt, $szBOWFeatureExt, $nMaxCodeBookSize = 2000, 
    $nStartVideoID = -1, $nEndVideoID = -1)
{
    ...
    for ($i = $nStartVideoID; $i < $nEndVideoID; $i ++) {
        ...
        extractRawSIFTFeatureForOneVideoProgram(
            $szLocalKeyFrameDir, $szLocalFeatureDir, 
            $szRootKeyFrameDir, $szRootMetaDataDir, $szPatName, $szVideoPath, $szVideoID, 
            $szInputRawFeatureExt, $szFeatureConfigParam);
        
        //exit("Checkpoint 1 - Raw feature extraction\n");
        // TO BE UPDATE
        computeSoftBOWHistogramWithGridForOneVideoProgram(
            $szLocalFeatureDir, $szRootFeatureOutputDir,
            $szFPKeyFrameListFN, 
            $szSashCentroidDir, $szSashCentroidName, $szPrefixAnn, 
            $szVideoPath, $szVideoID, $szInputRawFeatureExt, $szBOWFeatureExt, $nMaxCodeBookSize);
...
function computeSoftBOWHistogramWithGridForOneVideoProgram(
    $szLocalFeatureDir, $szRootFeatureOutputDir, 
    $szFPKeyFrameListFN, 
    $szSashCentroidDir, $szSashCentroidName, $szPrefixAnn, 
    $szVideoPath, $szVideoID, $szInputRawFeatureExt, $szBOWFeatureExt, $nMaxCodeBookSize = 2000)
{
    $arGridList = array(
        // 4 => 4,
        3 => 1,
...
*/      
        ...
        computeSoftWeightingHistogramWithGrid(
            $szFPKeyFrameListFN, $szFPLocalOutputFN, $szFPLocalInputFN, 
            $szLocalFeatureDir, $szInputRawFeatureExt, $nNumRows, $nNumCols, $nMaxCodeBookSize);
...
function computeSoftWeightingHistogramWithGrid(
    $szFPKeyFrameListFN, $szFPOutputFN, $szFPInputLabelFN, 
    $szLocalFeatureDir, $szInputRawFeatureExt, 
    $nNumRows = 2, $nNumCols = 2, $nMaxCodeBookSize = 2000) // for concatenating feature vectors of sub regions
{
 ...
 * $szLocalFeatureDir
*/
function computeAssignmentSash(
    $szLocalFeatureDir, $szFPLocalOutputFN, $szFPKeyFrameListFN,
    $szSashCentroidDir, $szSashCentroidName, $szPrefixAnn,
    $szVideoPath, $szVideoID, $szInputRawFeatureExt)
{
    global $fScaleFactor;
    global $nKNNSize;
 ...
 */
function extractRawSIFTFeatureForOneVideoProgram(
    $szLocalKeyFrameDir, $szLocalFeatureDir, 
    $szRootKeyFrameDir, $szRootMetaDataDir, 
    $szPatName, $szVideoPath, $szVideoID, $szFeatureExt, $szFeatureConfigParam)
{
