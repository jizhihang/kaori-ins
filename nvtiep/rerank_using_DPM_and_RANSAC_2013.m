function rerank_using_DPM_and_RANSAC_2013(data_name, base_feature, base_BOW_fusion, base_RANSAC, base_DPM, start_video_id, end_video_id)

% Customized version to run on tv2013 (ko theo qui uoc ten) --> check bug-free
...
base_BOW_fusion = 'R1_tv2013.fusion-BoW+DPM[2-1]';
base_RANSAC = '2.7.run_query2013-new_test2013-new_TiepBoW_No1_10K_combine_DPM_RANSAC';
base_DPM = '2.2.run_query2013-new_test2013-new_TiepBoW_No1_10K_combine_DPM';
