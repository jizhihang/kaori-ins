function rerank_using_DPM_and_RANSAC_2014_hard_soft_with_new_baserun(start_video_id, end_video_id)
% Example:
...
base_BOW_fusion = 'R1_tv2013.fusion-surrey.hard.soft-BOW+RANSAC_fg+bg_tfidf_max+DPM[1-1-1]';
base_RANSAC = 'R4_rawRANSAC_tv2013.surrey.hard.soft.latefusion.asym';
...
RESULT_RUN_ID = ['R0_', data_name, '.', base_BOW_fusion, '+DPM'];

if is_using_RANSAC
	RESULT_RUN_ID = ['R0_', data_name, '.', base_BOW_fusion, '+DPM+RANSAC'];
end
