function compute_raw_softRANSAC_final(feature_id, start_video_id, end_video_id, query_start, query_end)
...
arr_output('surrey.hard.soft') = 'R4_softRANSAC_tv2013.surrey.hard.soft.latefusion.asym';
arr_output('surrey.soft.soft') = 'R4_softRANSAC_tv2013.surrey.soft.soft.latefusion.asym';
arr_output('CaizhiBest') 	   = 'R4_softRANSAC_tv2013.CaizhiBest';
...
ex_bounding_box = 0;
RESULT_DIR = '/net/per610a/export/das11f/ledduy/trecvid-ins-2014/result/tv2013/test2013/';
...
qr_raw_bow = '/net/per610a/export/das11f/ledduy/trecvid-ins-2014/feature/keyframe-5/tv2013/query2013/bow.db_1_qr_fg+bg_0.1_hesaff_rootsift_noangle_akmeans_1000000_100000000_50_kdtree_8_800_kdtree_3_0.0125/raw_bow.mat';
db_quant_dir = '/net/per610a/export/das11g/caizhizhu/ins/ins2013/hesaff_l1rootsift_noangle_cluster_old/akmeans_1000000_100000000_50/kdtree_8_800/v1_f1_10_sub_quant';
db_frame_info_dir = '/net/per610a/export/das11f/ledduy/trecvid-ins-2014/feature/keyframe-5/tv2013/test2013/hesaff_rootsift_noangle_mat';
			...
			for shot_idx=1:nshot	% For all shots in the res file
				...
				for db_frame_id=1:nframe_per_shot	% For all frames of a shot
					...
					for topic_id = 1:length(query_set)	% For all frames of a query
						...
						pair = soft_matching(qr_words_id_fg(1:3,:), db_words_id(1:3,:));
						iqr_fg = pair(1,:);
						idb_fg = pair(2,:);
